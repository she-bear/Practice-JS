...
// Исправлено. Комментарий преподавателя:
// Методы стоит записать не стрелочными функциями. У стрелочных функций есть особенности при работе с this, контекст в этом примере мы не используем, но я не вижу выгоды использования стрелочной функции в данном случае. Тем более что если наш объект начнет работать с контентом, то точно придется поменять все методы на обычные функции.
